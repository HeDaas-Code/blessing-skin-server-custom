...
return function (Filter $filter) {
    ...
    Hook::addMenuItem('user', 0, [
        'title' => 'Yggdrasil::binding.title',
        'link'  => 'user/yggdrasil-binding',
        'icon'  => 'fa-microsoft'
    ]);
    ...
    Hook::addRoute(function () {
        ...
        Route::middleware(['web', 'auth', 'role:admin'])
            ...
            ->group(function () {
                ...
                Route::get('yggdrasil-bindings', 'BindingController@adminList');
            });
        ...
        Route::middleware(['web', 'auth'])
            ...
            ->prefix('user')
            ->group(function () {
                Route::get('yggdrasil-binding', 'BindingController@show');
                Route::get('yggdrasil-binding/redirect', 'BindingController@redirectToMicrosoft');
                Route::get('yggdrasil-binding/callback', 'BindingController@handleCallback');
                Route::get('yggdrasil-binding/device', 'BindingController@showDevice');
                Route::post('yggdrasil-binding/device/start', 'BindingController@startDevice');
                Route::post('yggdrasil-binding/device/poll', 'BindingController@pollDevice');
                Route::post('yggdrasil-binding/unbind', 'BindingController@unbind');
                Route::post('yggdrasil-binding/sync', 'BindingController@sync');
                Route::get('yggdrasil-binding/resolve', 'BindingController@resolve');
                Route::post('yggdrasil-binding/resolve/rename', 'BindingController@resolveRename');
            });
    });
